...
class DatabaseService {
  ...
  // creating a group
  Future createGroup(String userName, String groupId, String groupName) async {
    await groupCollection.doc(groupId).set({
      "groupName": groupName,
      "groupIcon": "",
      "admin": "${groupId}_$userName",
      "members": [],
      "groupId": groupId,
      "recentMessage": "",
      "recentMessageSender": "",
  ...
  Future<bool> isUserJoined(
      String memberId, String groupId, String memberName) async {
    ...
    if (members.contains("${memberId}_$memberName")) {
      return true;
    } else {
      return false;
    }
